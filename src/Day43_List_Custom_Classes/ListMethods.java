...
public class ListMethods {
    public static void main(String[] args) {
        ...
        System.out.println("Days list " + getDays());
        ...
        System.out.println("dayNames.add(\"java day\") = " + dayNames.add("java day"));

        // lambda method - java 8, accepts lambda - and easy to remove without loop
        dayNames.removeIf( me -> me.length() > 6);
